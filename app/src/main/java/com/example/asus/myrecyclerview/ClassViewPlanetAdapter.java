...
class CardViewPlanetAdapter extends RecyclerView.Adapter<CardViewPlanetAdapter.CardViewViewHolder>{
    private Context context;
    private ArrayList<Planet> listPlanet;
    private ArrayList<Planet> getListPlanet() {
        return listPlanet;
    }
    ...
    public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_cardview_planet, viewGroup, false);
        return new CardViewViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CardViewViewHolder cardViewViewHolder, int i) {
        Planet p = getListPlanet().get(i);
        Glide.with(context)
                .load(p.getPhoto())
        ...
        cardViewViewHolder.btnFavorite.setOnClickListener(new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Favorite "+getListPlanet().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
        cardViewViewHolder.btnShare.setOnClickListener(new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
            @Override
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Share "+getListPlanet().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
    }
